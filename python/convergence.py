...
fps = 50
ani = animation.FuncAnimation(fig=fig, func=update_frame, frames=nelem, interval=1000 / fps, repeat_delay=250)
ani.save("figures/convergence.gif", writer=animation.writers["ffmpeg"](fps=fps))
ani.save("figures/convergence.mp4", writer=animation.writers["ffmpeg"](fps=fps))
